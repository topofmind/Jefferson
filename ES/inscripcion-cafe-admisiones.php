			...
			<input type="hidden" value="FormCafe" name="nameForm">
                ...
                <div class="inputInset radio">		
						<div class="contRadio cafe">
							...
							<div>
								<label for="octubre25">Octubre 25 de 2019 (Cupo lleno)</label>
  								
                            </div>

                            <div>
								<label for="Noviembre1">Noviembre 1 de 2019 (Cupo lleno)</label>
  								
                            </div>

                            <div>
								<label for="Noviembre8">Noviembre 8 de 2019</label>
  								<input id="Noviembre8" type="radio" name="fecha1" value="Noviembre 8" >
                            </div>
