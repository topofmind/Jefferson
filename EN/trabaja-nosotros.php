...
<head>
	...
	<title>Colegio Jefferson |JOIN OUR STAFF</title>
</head>
<body>
	...
	<div class="contBox">
		...
		<div class="descriptioSection">
				<p>Please complete the following format y attach your C.V. All your personal data will be treated confidentially and will be checked only by Human Resources.</p>
			</div>
			...
			<input type="hidden" value="FormTrabajar" name="nameForm">
				<div class="contInput sugerencias">			
					<div class="inputInset">
						...
						<input type="email" name="titulo" placeholder="Titulo Académico" required>
					</div>
					<div class="inputInset">
