	...
	<div class="contBox">
		...
		<section class="infoSeccion admission column">
			<div class="description">
				...
				<img src="../img/img-proceso-admisiones-ingles.jpg" alt="">
				<button id="listMaterial" class="btnAdmision"><a href="../archives/Formulario-de-admisiones.pdf" target="_blank"><i class="fas fa-download"></i>Download your application form</a></button>
